================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : ForlijiaEx Project Overview
===============================================================================

The application wizard has created this ForlijiaEx application for
you.  This application not only demonstrates the basics of using the Microsoft
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your ForlijiaEx application.
...
ForlijiaEx.h
    ...
    CForlijiaExApp application class.

ForlijiaEx.cpp
    This is the main application source file that contains the application
    class CForlijiaExApp.
...
res\ForlijiaEx.ico
    ...
    icon is included by the main resource file ForlijiaEx.rc.
...
ForlijiaExDlg.h, ForlijiaExDlg.cpp - the dialog
    These files contain your CForlijiaExDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in ForlijiaEx.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CForlijiaExDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named ForlijiaEx.pch and a precompiled types file named StdAfx.obj.
