...
//        window.addEventListener("load",        handleWindowLoad, false);
        ...
        // load settings
        var port = chrome.extension.connect({name: "chromeTouch.loadSetting"});
...
//                delete backups.body.overflow;
    ...
    function shiftTouchMode() {
        ...
        var port = chrome.extension.connect({name: "chromeTouch.shiftTouchMode"});
...
/*
    function handleWindowLoad() {
        ...
        // capture tab image
        var port = chrome.extension.connect({name: "chromeTouch.captureTab"});
